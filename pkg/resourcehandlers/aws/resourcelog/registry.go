...
import (
	...
	"github.com/seal-io/walrus/pkg/resourcehandlers/aws/key"
...
func Log(ctx context.Context, k string, options resourcehandler.LogOptions) error {
	...
	if err != nil {
		klog.Warningf("error get log resource %s/%s: %v", resourceType, name, err)
	}
