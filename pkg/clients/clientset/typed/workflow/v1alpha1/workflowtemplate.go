...
type WorkflowTemplateInterface interface {
	...
	Apply(ctx context.Context, workflowTemplate *workflowv1alpha1.WorkflowTemplateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowTemplate, err error)
...
func (c *workflowTemplates) Apply(ctx context.Context, workflowTemplate *workflowv1alpha1.WorkflowTemplateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowTemplate, err error) {
