...
type CronWorkflowInterface interface {
	...
	Apply(ctx context.Context, cronWorkflow *workflowv1alpha1.CronWorkflowApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.CronWorkflow, err error)
...
func (c *cronWorkflows) Apply(ctx context.Context, cronWorkflow *workflowv1alpha1.CronWorkflowApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.CronWorkflow, err error) {
	if cronWorkflow == nil {
