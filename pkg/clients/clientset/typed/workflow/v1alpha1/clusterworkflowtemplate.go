...
type ClusterWorkflowTemplateInterface interface {
	...
	Apply(ctx context.Context, clusterWorkflowTemplate *workflowv1alpha1.ClusterWorkflowTemplateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterWorkflowTemplate, err error)
...
func (c *clusterWorkflowTemplates) Apply(ctx context.Context, clusterWorkflowTemplate *workflowv1alpha1.ClusterWorkflowTemplateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterWorkflowTemplate, err error) {
