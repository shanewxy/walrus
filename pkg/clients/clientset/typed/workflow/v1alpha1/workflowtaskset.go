...
type WorkflowTaskSetInterface interface {
	...
	Apply(ctx context.Context, workflowTaskSet *workflowv1alpha1.WorkflowTaskSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowTaskSet, err error)
	ApplyStatus(ctx context.Context, workflowTaskSet *workflowv1alpha1.WorkflowTaskSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowTaskSet, err error)
...
func (c *workflowTaskSets) Apply(ctx context.Context, workflowTaskSet *workflowv1alpha1.WorkflowTaskSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowTaskSet, err error) {
...
func (c *workflowTaskSets) ApplyStatus(ctx context.Context, workflowTaskSet *workflowv1alpha1.WorkflowTaskSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowTaskSet, err error) {
	if workflowTaskSet == nil {
		return nil, fmt.Errorf("workflowTaskSet provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
