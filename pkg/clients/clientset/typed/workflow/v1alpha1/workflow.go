...
type WorkflowInterface interface {
	...
	Apply(ctx context.Context, workflow *workflowv1alpha1.WorkflowApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workflow, err error)
	WorkflowExpansion
}
...
func (c *workflows) Apply(ctx context.Context, workflow *workflowv1alpha1.WorkflowApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workflow, err error) {
	if workflow == nil {
