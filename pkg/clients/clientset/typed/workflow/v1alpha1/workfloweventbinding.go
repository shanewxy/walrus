...
type WorkflowEventBindingInterface interface {
	...
	Apply(ctx context.Context, workflowEventBinding *workflowv1alpha1.WorkflowEventBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowEventBinding, err error)
...
func (c *workflowEventBindings) Apply(ctx context.Context, workflowEventBinding *workflowv1alpha1.WorkflowEventBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.WorkflowEventBinding, err error) {
