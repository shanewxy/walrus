...
type ConnectorBindingInterface interface {
	...
	ApplyStatus(ctx context.Context, connectorBinding *walrusv1.ConnectorBindingApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ConnectorBinding, err error)
...
func (c *connectorBindings) ApplyStatus(ctx context.Context, connectorBinding *walrusv1.ConnectorBindingApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ConnectorBinding, err error) {
	if connectorBinding == nil {
		return nil, fmt.Errorf("connectorBinding provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
