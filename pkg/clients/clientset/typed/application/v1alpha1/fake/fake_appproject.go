...
func (c *FakeAppProjects) Apply(ctx context.Context, appProject *applicationv1alpha1.AppProjectApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.AppProject, err error) {
	if appProject == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(appprojectsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.AppProject{})
