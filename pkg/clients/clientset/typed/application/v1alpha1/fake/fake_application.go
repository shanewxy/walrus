...
func (c *FakeApplications) Apply(ctx context.Context, application *applicationv1alpha1.ApplicationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Application, err error) {
	if application == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(applicationsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.Application{})
