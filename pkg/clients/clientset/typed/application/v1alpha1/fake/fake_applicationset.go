...
func (c *FakeApplicationSets) Apply(ctx context.Context, applicationSet *applicationv1alpha1.ApplicationSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ApplicationSet, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(applicationsetsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.ApplicationSet{})
