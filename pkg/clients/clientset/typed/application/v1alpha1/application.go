...
type ApplicationInterface interface {
	...
	Apply(ctx context.Context, application *applicationv1alpha1.ApplicationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Application, err error)
...
func (c *applications) Apply(ctx context.Context, application *applicationv1alpha1.ApplicationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Application, err error) {
	if application == nil {
