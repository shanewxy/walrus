...
type ApplicationSetInterface interface {
	...
	Apply(ctx context.Context, applicationSet *applicationv1alpha1.ApplicationSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ApplicationSet, err error)
...
// Apply takes the given apply declarative configuration, applies it and returns the applied applicationSet.
func (c *applicationSets) Apply(ctx context.Context, applicationSet *applicationv1alpha1.ApplicationSetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ApplicationSet, err error) {
	if applicationSet == nil {
		return nil, fmt.Errorf("applicationSet provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
	data, err := json.Marshal(applicationSet)
	if err != nil {
		return nil, err
	}
	name := applicationSet.Name
	if name == nil {
		return nil, fmt.Errorf("applicationSet.Name must be provided to Apply")
	}
	result = &v1alpha1.ApplicationSet{}
